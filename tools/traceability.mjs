...
export const routes = {
  ...
  firstProvider: route("first-cli-provider", "ACC-PROVIDER-001", "planned", "future first CLI provider conformance suite"),
...
const overrides = new Map(Object.entries({
  ...
  "REQ-PROVIDER-001": "print",
  "REQ-PROVIDER-002": "print",
  "REQ-PROVIDER-003": "print",
  "REQ-PROVIDER-004": "print",
  ...
  "REQ-TEST-002": "print",
  "REQ-TEST-003": "delivery",
  "REQ-TEST-004": "delivery",
  "REQ-TEST-005": "safety",
  "REQ-TEST-006": "release",
  "REQ-ROLL-001": "governance",
  "REQ-ROLL-002": "delivery",
  ...
  "REQ-FLEET-002": "host",
  "REQ-FLEET-003": "host",
  "REQ-FLEET-004": "canary",
  "REQ-FLEET-005": "canary",
